package com.example.weatheralarm.alarm.data;
...
public final class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "weatheralarms.db";
    ...
    public static final String COL_WEATHER_ALARM = "weather_alarm";
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String CREATE_ALARMS_TABLE = "CREATE TABLE " + TABLE_NAME + " (" +
                ...
                COL_WEATHER_ALARM + " INTEGER NOT NULL" +
                ");";
    ...
    public List<Alarm> getAlarms() {
        Cursor cursor = null;
        try{
            cursor = getReadableDatabase().query(TABLE_NAME, null, null, null, null, null, COL_TIME);
