...
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_FRI;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_IS_ENABLED;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_LABEL;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_MON;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_SAT;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_SUN;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_THURS;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_TIME;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_TUES;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_WED;
import static com.example.weatheralarm.alarm.data.DatabaseHelper._ID;
import static com.example.weatheralarm.alarm.data.DatabaseHelper.COL_WEATHER_ALARM;
...
public final class AlarmUtils {
    ...
    public static ContentValues toContentValues(Alarm alarm) {
        ...
        cv.put(DatabaseHelper.COL_WEATHER_ALARM, alarm.isWeatherVoice());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c) {
        ...
        if (c.moveToFirst()){
            do {
                ...
                final boolean weatherAlarm = c.getInt(c.getColumnIndex(COL_WEATHER_ALARM)) == 1;

                final Alarm alarm = new Alarm(id, time, label, weatherAlarm);
