...
public final class LineBelowAlarm extends RecyclerView.ItemDecoration {

    private static final int DIVIDER_HEIGHT = (int) TimepickerUtils.dpToPx(1);
    private Drawable mDivider;

    public LineBelowAlarm(Context context) {
        this(context, null);
    }

    public LineBelowAlarm(Context context, Drawable divider) {
